        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-[3fr_2fr]">
          ...
          >
            ...
            <div className="flex items-center justify-between gap-3">
              <span className="text-[11px] font-black uppercase tracking-[0.20em]" style={{ color: "oklch(0.75 0.15 250)" }}>
                Premium
              </span>
              <span
            ...
            <p className="mt-1 text-xs leading-5" style={{ color: "oklch(0.63 0.03 256)" }}>
