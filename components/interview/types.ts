...
export type InterviewUiState = { status: InterviewStatus; premiumVoiceStatus: PremiumVoiceStatus; elapsedLabel: string; scoreReady: boolean; questionIndex: number; progress: number; transcriptCollapsed: boolean; copilotEnabled: boolean; isPremiumUnlocked?: boolean; };
export type InterviewUiActions = { onBack: () => void; onStart: () => void; onEnd: () => void; onToggleMute: () => void; onToggleSettings: () => void; onToggleMore: () => void; onToggleTranscript: () => void; onToggleCopilot: () => void; onClearTranscript: () => void; };
export type InterviewLayoutProps = { setup: InterviewSetupViewModel; signal: RecruiterSignalViewModel; transcript: TranscriptItem[]; ui: InterviewUiState; actions: InterviewUiActions; };
